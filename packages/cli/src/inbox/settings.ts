...
export const SETTINGS_KEYS = ['filter', 'skipTitles', 'alertWhen', 'alertPaths', 'postAlerts', 'postPrefix', 'postFooter', 'maxPrepared', 'pollMinutes', 'live', 'liveTimeoutMinutes', 'prepareTimeoutMinutes', 'waitForCi', 'agent', 'validate'] as const;
