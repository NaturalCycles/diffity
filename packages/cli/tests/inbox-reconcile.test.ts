...
function existing(over: Partial<InboxPr> = {}): InboxPr {
  return {
    ...
    ciState: null, createdAt: null, updatedAt: null, bumpedAt: null, summary: null, alert: null, alertFindings: [], requested: true, status: 'prepared', statusReason: null, attempts: 0, preparedHeadSha: 'aaa', preparedAt: '2026-09-02T09:00:00Z',
